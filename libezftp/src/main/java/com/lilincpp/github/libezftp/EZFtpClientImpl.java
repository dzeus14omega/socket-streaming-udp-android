...
final class EZFtpClientImpl implements IEZFtpClient {
    ...
    private void callbackNormalSuccess( final OnEZFtpCallBack callBack,  final Object response) {
        EZFtpSampleCallbackWrapper wrapper = new EZFtpSampleCallbackWrapper(callBack);
        wrapper.onSuccess(response);
    }

    @SuppressWarnings("unchecked")
    private void callbackNormalFail( final OnEZFtpCallBack callBack, final int code, final String msg) {
        EZFtpSampleCallbackWrapper wrapper = new EZFtpSampleCallbackWrapper(callBack);
    ...
    @Override
    public void connect(final String serverIp, final int port, final String userName, final String password) {
        connect(serverIp, port, userName, password, null);
    }

    @Override
    public void connect(final String serverIp, final int port, final String userName, final String password,  final OnEZFtpCallBack<Void> callBack) {
        checkInit();
    ...
    @Override
    public void disconnect( final OnEZFtpCallBack<Void> callBack) {
        checkInit();
        taskHandler.post(new Runnable() {
            @Override
            public void run() {
    ...
    @Override
    public void getCurDirFileList( final OnEZFtpCallBack<List<EZFtpFile>> callBack) {
        checkInit();
        taskHandler.post(new Runnable() {
            @Override
            public void run() {
    ...
    @Override
    public void getCurDirPath( final OnEZFtpCallBack<String> callBack) {
        checkInit();
        taskHandler.post(new Runnable() {
            @Override
            public void run() {
    ...
    @Override
    public void changeDirectory( final String path,  final OnEZFtpCallBack<String> callBack) {
        checkInit();
        taskHandler.post(new Runnable() {
            @Override
            public void run() {
    ...
    @Override
    public void backup( final OnEZFtpCallBack<String> callBack) {
    ...
    @Override
    public void downloadFile(final EZFtpFile remoteFile, String localFilePath,  OnEZFtpDataTransferCallback callback) {
        checkInit();
    ...
    @Override
    public void uploadFile(final String localFilePath,  OnEZFtpDataTransferCallback callback) {
        checkInit();
